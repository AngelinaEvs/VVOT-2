...
def send_photos(photos_db_rows, body):
    ...
    for photo_row in photos_db_rows:
        ...
        photo_url = "https://d5d8330f80kcs8vco0tk.apigw.yandexcloud.net/orig_photo/" + photo_row['photo']
...
def getUnsignedPhoto():
    ...
    url_photo = 'https://d5d8330f80kcs8vco0tk.apigw.yandexcloud.net/static/' + object_id
