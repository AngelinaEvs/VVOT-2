...
async def hello(request):
    bucket = 'itis-2022-2023-vvot40-photos'
    new_bucket = 'itis-2022-2023-vvot40-faces'
    ...
    ydb_client = session.client('dynamodb', endpoint_url='https://docapi.serverless.yandexcloud.net/ru-central1/b1g71e95h51okii30p25/etnig856uuujqnekk95m', aws_access_key_id='', aws_secret_access_key='')
